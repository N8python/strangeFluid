...
self.onmessage = function(e) {
    if (e.data.type === 'init') {
        ...
        update(e.data.deltaTime, e.data.mouseData);
    }
};
...
function update(deltaTime, mouseData) {
    ...
    for (let i = 0; i < numSpheres; i++) {
        ...
        let newY = 2 * spheres[index + 1] - oldY + 1000 * deltaTime * deltaTime;
        ...
        if (mouseDown) {
            ...
            if (distSquared < 200 * 200) {
                ...
                newX -= force * dx / dist * deltaTime * deltaTime;
                newY -= force * dy / dist * deltaTime * deltaTime;
            }
        }
